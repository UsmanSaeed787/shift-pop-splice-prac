...
var FriendsNames1 = ["Danial", "Hassan", "Ihtesham", "Awais"];
for (var i = 0; i < FriendsNames1.length; i++) {
...
//name.
var FriendsNames2 = ["Danial", "Hassan", "Ihtesham", "Awais"];
for (var i = 0; i < FriendsNames2.length; i++) {
...
var MyCar = ["Black Color", "Good Fuel Average", "AC", "excellent Suspension"];
for (let i = 0; i < 1; i++) {
...
let DinnerInvite = ["Haseeb", "Muneeb", "Furqan"];
...
let DinnerGuest = ["Haseeb", "Muneeb", "Furqan"];
for (let i = 0; i < 1; i++) {
...
let DinnerInvAdd = ["Haseeb", "Muneeb", "Furqan"];
{
